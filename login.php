                ...
                if ($num_of_rows = $stmt->num_rows >= 1) {
                    ...
                    if (mysqli_num_rows($b) >= 1) {
                      echo '<META HTTP-EQUIV="Refresh" Content="0; URL=index.php">';
                        ...
                        $c = "INSERT INTO category(UserId, CategoryName, Level) VALUES ($UserIds, 'Salary', 1), 
                            ($UserIds, 'Alowance', 1), ($UserIds, 'Petty Cash', 1), ($UserIds, 'Bonus', 1), ($UserIds, 'Food', 2),
							($UserIds, 'Social Life', 2), ($UserIds, 'Self-Development', 2), ($UserIds, 'Transportation', 2), 
                            ($UserIds, 'Culture', 2), ($UserIds, 'Household', 2), ($UserIds, 'Apparel', 2), 
...
<head>
    ...
    <title>zon Finance Manager Login</title>
...
$Passwords; ?>" name="password" type="password" value="">
                               ...
                               <hr>
                                <button type="submit" name="login" class="btn btn-success btn-block">
                                    <span class="glyphicon glyphicon-log-in"></span>  <?php echo
$SignIn; ?></button>                                 <hr>
...
$RegisterAnAccount; ?></a>
        ...
        <div class="row text-center">
            <small >copyright © <?php echo Date('Y'); ?> Horizon Finance Manager | All right Reserved</small><br>
