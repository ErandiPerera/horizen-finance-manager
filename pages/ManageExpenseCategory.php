                    ...
                    <div class="panel panel-red">
	                	...
	                	<tbody>
							...
							<td colspan="2" class="notification">
								<a href="#EditCat<?php echo $col['CategoryId'];?>" class="" data-toggle="modal"><span class="btn btn-primary btn-xs glyphicon glyphicon-edit" 
                                data-toggle="tooltip" data-placement="left" title="" data-original-title="<?php echo $EditCategory; ?>"></span></a>
								<a href="#DeleteCat<?php echo $col['CategoryId'];?>"  data-toggle="modal"><span class=" glyphicon glyphicon-trash btn btn-primary btn-xs"
                                 data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo $DeleteCategories; ?>"></span></a>			
							</td>
							</tr>
	                	</tbody>
