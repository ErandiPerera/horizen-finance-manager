                    ...
                    <div class="panel panel-warning">
	                	...
	                	<tbody>
							...
							<td colspan="2" class="notification">
								<a href="#EditBudget<?php echo $col['BudgetId'];?>" class="" data-toggle="modal"><span class="btn btn-primary btn-xs glyphicon glyphicon-edit"
                                 data-toggle="tooltip" data-placement="left" title="" data-original-title="<?php echo $EditBudget; ?>"></span></a>
								<a href="#DeleteBudget<?php echo $col['BudgetId'];?>"  data-toggle="modal"><span class=" glyphicon glyphicon-trash btn btn-primary btn-xs" 
                                data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo $DeleteBudgets; ?>"></span></button>			
							</td>
							</tr>
	                	</tbody>
