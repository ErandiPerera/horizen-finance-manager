                    ...
                    <div class="panel panel-info">
	                	...
	                	<tbody>
							...
							<td colspan="2" class="notification">
								<a href="#EditCat<?php echo $col['AccountId'];?>" class="" data-toggle="modal"><span class="btn btn-primary btn-xs glyphicon glyphicon-edit" 
                                data-toggle="tooltip" data-placement="left" title="" data-original-title="<?php echo $EditAccount; ?>"></span></a>
								<a href="#DeleteCat<?php echo $col['AccountId'];?>"  data-toggle="modal"><span class=" glyphicon glyphicon-trash btn btn-primary btn-xs" 
                                data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo $DeleteAccounts; ?>"></span></a>			
							</td>
							</tr>
	                	</tbody>
